...
function startTest() : TTRPGSystemJSONFormatting{
...
@JsonObject({
	...
	onBeforeDeSerialization : (self, JsonObject ) => { 
		...
		switch(JsonObject['type']){
			case 'Feature_StatIncrease_apply' : return new JsonFeature_StatIncrease_apply()
			default:
				return self;
		}
	}
...
class JsonFeature_StatIncrease_apply extends Feature_StatIncrease_apply{
	@JsonString()
